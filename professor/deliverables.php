...
$sql ="SELECT deliv_files.*,user_account.* FROM (deliv_files INNER JOIN user_account ON deliv_files.file_uid = user_account.user_id) WHERE file_uid =".$_SESSION['user_id'];
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-download"></i> Deliverables  <a href="add-upload.php" class="btn btn-info">Upload a File</a></h3>
              <hr>
