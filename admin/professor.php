...
$student = getdata_where("*","user_role","user_account","1");
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-users"></i> Professor - <a href="add-professor.php" class="btn btn-info">Add Information</a> <!--- <a href="upload-professor.php">Upload CSV</a>--></h3>
              <hr>
