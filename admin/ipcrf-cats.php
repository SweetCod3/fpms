...
$query = "SELECT * FROM ipcrf_category ORDER BY cat_id ASC";
$question = getdata_inner_join($query);
if(isset($_GET['delete'])){ // Deleting records on the database.
  $delete = filter($_GET['delete']);
  $ar = array("cat_id"=>$delete); //WHERE statement
  $tbl_name = "ipcrf_category"; 
  $del = Delete($dbcon,$tbl_name,$ar);
  if($del){
    header("location: ipcrf_cats.php");
  }
}
?>
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-book"></i> IPCRF Category List - <a href="add-category.php" class="btn btn-info">Add Data</a></h3>
              <hr>
              ...
              <?php foreach ($question as $key => $value):?>
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="add-category.php?cat_id=<?php echo $value->cat_id?>"><i class="fa fa-pencil"></i> Update</a></li>
                    <li>
                      <a href="#" <?php echo 'onclick=" confirm(\'Are you sure you want to Delete?\') 
      ?window.location = \'ipcrf-cats.php?delete='.$value->cat_id.'\' : \'\';"'; ?>><i class="fa fa-remove"></i> Delete</a>
    </li>
                  </ul>
                  </div>
                  </td>
