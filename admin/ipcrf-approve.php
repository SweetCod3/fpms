...
$query = "SELECT ipcrf_ansf.*, user_account.user_id,user_account.fname,user_account.mname,user_account.lname, user_account.suffix FROM (ipcrf_ansf INNER JOIN user_account ON ipcrf_ansf.fans_fid = user_account.user_id) WHERE fans_appr = 1";
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-users"></i> <i class="fa fa-file"></i> Professor's Reviewed IPCRFs </h3>
              <hr>
