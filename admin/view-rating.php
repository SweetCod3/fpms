...
$kweri1 = "SELECT * FROM questions WHERE question_cat = 'A. Commitment' ORDER BY q_id ASC";
$mastery = getdata_inner_join($kweri1);
$kweri11 = $dbcon->query($kweri1);
$count1 = mysqli_num_rows($kweri11);

$kweri2 = "SELECT * FROM questions WHERE question_cat = 'B. Knowledge of the subject' ORDER BY q_id ASC";
$teaching = getdata_inner_join($kweri2);
$kweri22 = $dbcon->query($kweri2);
$countb = mysqli_num_rows($kweri22);

$kweri3 = "SELECT * FROM questions WHERE question_cat = 'C. Teaching for independent learning' ORDER BY q_id ASC";
$personal = getdata_inner_join($kweri3);
$kweri33 = $dbcon->query($kweri3);
$countc = mysqli_num_rows($kweri33);

$kweri4 = "SELECT * FROM questions WHERE question_cat = 'D. Management of learning' ORDER BY q_id ASC";
$last = getdata_inner_join($kweri4);
$kweri44 = $dbcon->query($kweri4);
$countd = mysqli_num_rows($kweri44);
...
<?php 
$total1 = '0';
  $query3 = $dbcon->query("SELECT SUM(r_result / $count1) as total FROM `result` WHERE question_cat = 'A. Commitment' AND e_code = '".$_GET['e_code']."' GROUP BY user_id") or die(mysqli_error());
  $count = mysqli_num_rows($query3);
  while($row = $query3->fetch_assoc()){
  echo   $total1 += $row['total'] / $count;
  }
...
<?php 
$total2 = '0';
  $query3 = $dbcon->query("SELECT SUM(r_result / $countb) as total FROM `result` WHERE question_cat = 'B. Knowledge of the subject' AND e_code = '".$_GET['e_code']."' GROUP BY user_id") or die(mysqli_error());
  $count = mysqli_num_rows($query3);
  while($row = $query3->fetch_assoc()){

  echo $total2 += $row['total'] / $count;
  }
...
<?php 
$total3 = '0';
  $query3 = $dbcon->query("SELECT SUM(r_result / $countc) as total FROM `result` WHERE question_cat = 'C. Teaching for independent learning' AND e_code = '".$_GET['e_code']."' GROUP BY user_id") or die(mysqli_error());
  $count = mysqli_num_rows($query3);
  while($row = $query3->fetch_assoc()){

   echo $total3 += $row['total'] / $count;
  }
...
<?php 
$total4 = '0';
  $query3 = $dbcon->query("SELECT SUM(r_result / $countd) as total FROM `result` WHERE question_cat = 'D. Management of learning' AND e_code = '".$_GET['e_code']."' GROUP BY user_id") or die(mysqli_error());
  $count = mysqli_num_rows($query3);
  while($row = $query3->fetch_assoc()){

    echo $total4 += $row['total'] / $count;
  }
