...
$student = getdata_where("*","user_role","user_account","11");
...
<?php include'../assets/admin_sidebar.php';?>
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-users"></i> Unverified Professor Accounts 
                <!--
 ...
 <?php echo $value->lname?> <?php echo $value->suffix?>                    </td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="profVerify.php?user_id=<?php echo $value->user_id?>"><i class="fa fa-check"></i> Verify</a></li>
                    <li>
                      <a href="#" <?php echo 'onclick=" confirm(\'Are you sure you want to Delete?\') 
      ?window.location = \'professor.php?delete='.$value->user_id.'\' : \'\';"'; ?>><i class="fa fa-remove"></i> Deny</a>
    </li>
