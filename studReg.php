  ...
  if(isset($_POST['login_button'])){
    ...
    switch (true) {
      ...
      break;
        ...
        $sql = 
        "INSERT INTO user_account (`user_name`,`pass`,`user_role`,`fname`, `lname`,`section_name`, `user_email`) 
        VALUES ('$uName','$pass','22','$fname','$lname','$section','$gMail')";
...
<?php include'assets/header.php';?>
  ...
  <body style="background:#d8b242;">
    ...
    <div class="col-lg-4" style="background:#f9f9f9;padding:20px;margin-top:2%;border:1px solid #dee2e6; border-radius:3px; ">
      ...
      <?php if(isset($gdmsg)):?><div class="alert alert-danger"><?php echo $gdmsg;?></div><?php endif;?>
      <center> <p>Welcome to Student Registration</p> </center>
       ...
       echo '<input type="radio" name="section" value="'?> <?php echo $value->section_id?><?php echo '"/> '?> <?php echo $value->section_name?> <?php echo '</td>' ?>
      <?php endforeach;?> 
      </center>  
      </div>
         <div class="form-group">
